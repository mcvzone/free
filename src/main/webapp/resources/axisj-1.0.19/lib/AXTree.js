 ...
 * @logs
 ...
 "2015-05-01 tom : setList 했을 때 정렬이 안되는 문제 수정"
 "2015-05-03 tom : resetHeight 버그 픽스"
 "2015-06-26 tom : 추가 2번 이상 생성후 추가요소 삭제후 순서 변경시 삭제된 아이템이 순서 잡아먹음 버그픽스 https://github.com/axisj/axisj/issues/629"
 "2015-07-26 HJ.Park : AXGrid.getFormatterValue -> AXTree.getFormatterValue 반영
 "2015-08-22 HJ.Park : getFormatterValue 버그 수정 gridCheckBox_body_colSeq -> treeCheckBox_body_colSeq https://github.com/axisj/axisj/issues/688
 *
 * @description
 *
 * ```js
